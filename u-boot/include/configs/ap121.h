...
#undef CONFIG_BOOTARGS
	...
	#define	CONFIG_BOOTARGS "console=ttyATH0,115200 board=domino root=31:03 rootfstype=squashfs,jffs2 noinitrd mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,1280k(kernel),14656k(rootfs),64k(nvram),64k(art)ro,15936k@0x50000(firmware)"
...
#define CFG_DDR_CONFIG_VAL		0x7FD6AEF3
...
#define CFG_DDR_CONFIG2_VAL				0x9DD0E7A8	// HORNET 1.1
...
#define CONFIG_EXTRA_ENV_SETTINGS	"uboot_addr=0x9F000000\0" \
									...
									"firmware_name=openwrt-gl-ar150.bin\0" \
									"lf=" \
										"if ping $serverip; then " \
										...
										"fi\0" \
									"lc=" \
										"cp.b 0x9fff0000 0x81000000 0x10000 &&" \
										"tftp 0x81000000 config.bin &&" \
										"erase 0x9fff0000 +0x10000 &&"			\
										"cp.b 0x81000000 0x9fff0000 0x10000\0" \
									SILENT_ENV_VARIABLE
