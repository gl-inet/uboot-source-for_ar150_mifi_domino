...
#define GPIO_WAN_LED_BIT  13
#define GPIO_WAN_LED_ON   1
...
#elif defined(CONFIG_FOR_DOMINO)
	SETBITVAL(gpio, GPIO_WLAN_LED_BIT, GPIO_WLAN_LED_ON);
	//SETBITVAL(gpio, GPIO_WAN_LED_BIT,  GPIO_WLAN_LED_ON);
#elif defined(CONFIG_FOR_DRAGINO_V2)
	SETBITVAL(gpio, GPIO_WLAN_LED_BIT,     GPIO_WLAN_LED_ON);
	SETBITVAL(gpio, GPIO_WAN_LED_BIT,      GPIO_WAN_LED_ON);
...
void gpio_control(unsigned char gpio_num,unsigned char gpio_high_or_low ){
	unsigned int gpio;
	gpio = ar7240_reg_rd(AR7240_GPIO_OUT);
	SETBITVAL(gpio, gpio_num, gpio_high_or_low);
	ar7240_reg_wr(AR7240_GPIO_OUT, gpio);
	//printf("*******************************\n");
	//printf("gpio_num:%d\n",gpio_num);
	//printf("gpio_high_or_low:%d\n",gpio_high_or_low);
	//printf("*******************************\n");
}
...
void gpio_config(void){
	...
	ar7240_reg_wr(AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | 0x2a001));
#elif defined(CONFIG_FOR_DRAGINO_V2)
	...
	/* set GPIO_OE */
	ar7240_reg_wr(AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | 0x1002a001));
