...
int check_tftp_file()
{
	...
	tftp_file = 1;
	run_command("tftp 80010000 openwrt-gl-ar150.bin",0);
	if(tftp_file){
...
extern void gpio_control(unsigned char gpio_num,unsigned char gpio_high_or_low);
